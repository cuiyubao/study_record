...
// 题目数据确保队列可以被重建 
// 
// Related Topics 贪心 数组 排序 👍 1060 👎 0
...
public class QueueReconstructionByHeight {
    ...
    public static void main(String[] args) {
        ...
        solution.reconstructQueue(new int[][]{new int[]{7,0},new int[]{4,4},new int[]{7,1},new int[]{5,0},new int[]{6,1},new int[]{5,2}});
    }
    ...
    class Solution {
        public int[][] reconstructQueue(int[][] people) {
            ...
            for (int[] p : people) {
                //放置的时候前面放置过的人身高肯定比自己高
                //所以直接放在自己k的位置就好
                //把数组放在目标索引位置上，原来有数了，会被往后挤
                queue.add(p[1], p);
            }
            return queue.toArray(new int[1][]);
        }
    }
