        ...
        public int findMinArrowShots(int[][] points) {
            ...
            Arrays.sort(points, new Comparator<int[]>() {
                ...
                public int compare(int[] o1, int[] o2) {
                    //入参：[[-2147483646,-2147483645],[2147483646,2147483647]]
                    //因为-2147483645-2147483647会发生异常，所以采用如下方法，也可以采用(o1, o2) -> Integer.compare(o1[1], o2[1])
